    ...
    internal static class TessApi
    {
        ...
        public static void Initialize()
        {
            if (native == null) {
                ...
                //Console.Out.WriteLine(Newtonsoft.Json.JsonConvert.SerializeObject(native));
                //Debug.Print(Newtonsoft.Json.JsonConvert.SerializeObject(native));
            }
        }
