...
namespace Tesseract
{
    ...
    public class BitmapToPixConverter
    {
        ...
        public Pix Convert(System.Drawing.Bitmap img)
        {
            ...
            try {
                ...
                // transfer data
                imgData = img.LockBits(new System.Drawing.Rectangle(0, 0, img.Width, img.Height), ImageLockMode.ReadOnly, img.PixelFormat);
                pixData = pix.GetData();
        ...
        private void CopyColormap(System.Drawing.Bitmap img, Pix pix)
        {
